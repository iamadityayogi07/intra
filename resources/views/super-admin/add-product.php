    ...
    <div class="row mb-8">
        <div class="col-md-12">
            <div class="d-md-flex justify-content-between align-items-center">
                ...
                <!-- button -->
                <div>
                    <a href="products.php" class="btn btn-light text-light">Back to Product</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <select class="form-select">
                                ...
                                <option value="Dairy, Bread & Eggs">Dairy</option>
                                <option value="Snacks & Munchies">Snacks</option>
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" class="form-control" placeholder="Unit ( kg, Pc etc)" required />
                        </div>
                        <!-- input -->
                        <div class="mb-3 col-lg-6">
                        ...
                        <div>
                            <div class="mb-3 col-lg-12 mt-5">
                                <!-- heading -->
                                <h4 class="mb-3 h5">Thumbnail Image</h4>
        ...
        <div class="col-lg-4 col-12">
            ...
            <div class="card mb-6 card-lg">
             ...
             <div class="card mb-6 card-lg">
                <!-- card body -->
                <div class="card-body p-6">
                    <h4 class="mb-4 h5">Low Stock Quantity Warning</h4>
                    <!-- input -->
                    <div class="mb-3">
            ...
            <!-- button -->
            <div class="d-grid">
                <a href="#" class="btn btn-primary py-3">Create Product</a>
            </div>
        </div>
    </div>
</div>
